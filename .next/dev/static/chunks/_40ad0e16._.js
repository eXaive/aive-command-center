    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IntelFeed.useEffect": ()=>{
            ...
            const subscription = supabase.channel('intel_feed_updates').on('postgres_changes', {
                ...
                "IntelFeed.useEffect.subscription": ()=>{
                    loadIntel();
                }
            }["IntelFeed.useEffect.subscription"]).subscribe();
            return ({
                "IntelFeed.useEffect": ()=>supabase.removeChannel(subscription)
            })["IntelFeed.useEffect"];
        }
    }["IntelFeed.useEffect"], [
        category
...
_s(IntelFeed, "vv5/iI8RnHyhMS3bgtXuT25VMMc=");
_c = IntelFeed;
var _c;
...
function TrendPanel() {
    ...
    const [glowSequence, setGlowSequence] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Fetch & aggregate
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrendPanel.useEffect": ()=>{
            async function loadTrends() {
                const { data } = await supabase.from('intel_feed').select('region, sentiment_level, impact_score, confidence_score');
                if (!data) return;
                const grouped = {};
                data.forEach({
                    "TrendPanel.useEffect.loadTrends": (item)=>{
                ...
                }["TrendPanel.useEffect.loadTrends"]);
                const aggregated = Object.values(grouped).map({
                    "TrendPanel.useEffect.loadTrends.aggregated": (g)=>({
                            ...g,
                            impact_score: Math.round(g.impact_score / g.count),
                            confidence_score: Math.round(g.confidence_score / g.count)
                        })
                }["TrendPanel.useEffect.loadTrends.aggregated"]);
            ...
            const subscription = supabase.channel('intel_feed_ripple').on('postgres_changes', {
                ...
                "TrendPanel.useEffect.subscription": (payload)=>{
            ...
            }["TrendPanel.useEffect.subscription"]).subscribe();
            return ({
                "TrendPanel.useEffect": ()=>supabase.removeChannel(subscription)
            })["TrendPanel.useEffect"];
        }
    }["TrendPanel.useEffect"], []);
...
_s(TrendPanel, "x1Uo6YhAyd6zGAN1XAn/O5uVvds=");
_c = TrendPanel;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CategoryPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CategoryPanel.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
_s(Home, "nr7g9usz2GX9jcf15aQlLnCXugA=");
_c = Home;
var _c;
...
//# sourceMappingURL=_40ad0e16._.js.map