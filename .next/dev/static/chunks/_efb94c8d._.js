...
function CrashWatch() {
    ...
    /* Simulate sentiment / crash-risk values */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CrashWatch.useEffect": ()=>{
            const obj = {};
            COUNTRIES.forEach({
                "CrashWatch.useEffect": (c)=>obj[c.code] = Math.floor(Math.random() * 100)
            }["CrashWatch.useEffect"]);
            setScores(obj);
        }
    }["CrashWatch.useEffect"], []);
...
_s(CrashWatch, "iFPybfEmU38HuP5Vb3gJWs2sCb8=", false, function() {
    return [
...
_s(HomePage, "fqiS1RsM69X19jAzWwICRZpld60=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=_efb94c8d._.js.map