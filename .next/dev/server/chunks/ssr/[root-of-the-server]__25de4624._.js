...
function CountryIntelPage() {
    ...
    const [sentiment, setSentiment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(50);
    const code = country?.toLowerCase() || "us";
    const countryName = COUNTRY_MAP[country?.toUpperCase() || "US"] || country?.toUpperCase();
    ...
    // Map 3-letter or mixed codes to the 2-letter ones FlagCDN uses
    const COUNTRY_CODE_MAP = {
        US: "us",
        USA: "us",
        CN: "cn",
    ...
    const code2 = COUNTRY_CODE_MAP[country?.toUpperCase() || "US"] || "us";
    const flagUrl = `https://flagcdn.com/48x36/${code2}.png`;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function load() {
            try {
                ...
                setNews(data.items || []);
                setSentiment(Math.round(Math.random() * 100));
            } catch (err) {
                console.error("❌ Failed to load country news", err);
            } finally{
                setLoading(false);
            }
        }
    ...
    const sentimentColor = sentiment > 70 ? "text-red-600" : sentiment > 50 ? "text-amber-500" : "text-blue-600";
    const sentimentText = sentiment > 70 ? "⚠️ High Risk" : sentiment > 50 ? "🟡 Moderate" : "🟦 Stable";
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    ...
                                    onError: (e)=>{
                                        e.currentTarget.src = "/placeholder_flag.png";
                                    }
                                }, void 0, false, {
                                    fileName: "[project]/app/intel/[country]/page.tsx",
                                    lineNumber: 99,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__25de4624._.js.map