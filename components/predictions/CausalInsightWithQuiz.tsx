...
/* -------------------------------------------------------------
   Helper → Log to prediction_learning_log
--------------------------------------------------------------*/
...
/* -------------------------------------------------------------
   COMPONENT
--------------------------------------------------------------*/
export default function CausalInsightWithQuiz({
  prediction,
}: {
  ...
  /* -------------------------------------------------------------
     Load related CAS nodes for cluster graph
  --------------------------------------------------------------*/
  useEffect(() => {
    if (!cas) return;
  ...
  const autoVerify = async () => {
    ...
    setTimeout(() => {
      setResult({ message: cas.cause, done: true });
    }, 2000);
  ...
  return (
    <div className="p-4 rounded-xl bg-slate-900/50 border border-blue-800/30 space-y-4">
      ...
      <p className="text-slate-200 text-sm">
        <span className="text-blue-400 font-semibold">Cause:</span>{" "}
        {cas.cause}
      </p>

      <p className="text-slate-200 text-sm">
        <span className="text-blue-400 font-semibold">Effect:</span>{" "}
        {cas.effect}
      </p>
